...
const HeroSection = () => {
  ...
  return (
    <section
      id="home"
      className="relative min-h-screen bg-gradient-to-r from-[#0079C1] to-[#00A6A6] animate-gradient flex flex-col"
      style={{
        paddingTop: "calc(env(safe-area-inset-top, 0) + 5rem)", // increased to 5rem
    ...
    >
      ...
      <div className="relative z-10 flex-1 flex items-center justify-center">
        <div className="container mx-auto px-4 text-white text-center flex flex-col items-center">
          ...
          <p className="text-lg max-w-3xl mx-auto mb-6 leading-relaxed">
            At <span className="font-bold">Planning Resources Center</span>, we offer truly{" "}
            <strong>independent</strong>, <strong>fiduciary-based</strong> financial and insurance solutions tailored to your unique goals. With{" "}
            <strong>no sales quotas</strong> and a commitment to <strong>transparency</strong>, our only focus is{" "}
